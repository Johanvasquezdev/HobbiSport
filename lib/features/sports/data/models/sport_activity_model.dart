...
class SportActivityModel extends SportActivity {
  ...
  factory SportActivityModel.fromFirestore(DocumentSnapshot<Map<String, dynamic>> doc) {
    final d = doc.data()!;
  ...
  factory SportActivityModel.fromJson(Map<String, dynamic> json) => SportActivityModel(
  ...
  factory SportActivityModel.fromEntity(SportActivity entity) => SportActivityModel(
        id: entity.id,
